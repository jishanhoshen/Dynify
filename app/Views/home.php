...
<section class="section5" style="padding-bottom: 100px">
  <div class="container">
    <div class="row">
...
<script>
  ...
  $('#contactForm').on('submit', function(e) {
    ...
    $('#contactForm [type="submit"]').prop('disabled', true);
    ...
    if (formData.name === "") {
      ...
      toastr.error('Name must be between 3 and 50 characters');
      $('#name').addClass('is-invalid');
      isValid = false;
    } else {
    ...
    // Check if phone is not empty and valid
    if (formData.phone === "") {
    ...
    if (formData.message === "") {
      ...
      toastr.error('Message must be between 10 and 500 characters');
      $('#message').addClass('is-invalid');
      isValid = false;
    } else {
    ...
    if (isValid) {
      ...
      $.ajax({
        url: '/sendemail', // Your PHP email handler script
        type: 'POST',
        data: formData,
        success: function(response) {
          ...
          $('#contactForm [type="submit"]').prop('disabled', false);
        },
